...
export default function Navbar() {
    return (
        <div className="fixed top-5 left-0 right-0 z-[1000] m-11 flex justify-center items-center">
            <nav
                id="navbar"
                className="bg-violet-300/30 shadow-md rounded-full mx-6 backdrop-filter backdrop-blur-2xl bg-opacity-60 firefox:bg-opacity-60"
            >
                <div className="px-4 sm:px-6 lg:px-11">
