    ...
    return (
        ...
        >
            ...
            <div className="text-white text-md md:text-lg lg:text-xl text-center w-1/2 py-22">
                FFDC 2024 Virtual Hackathon is an open call, you don't have to
                attend FFDC in person. Some geographic restrictions apply. Team
                size is 4(fixed)
                <br />
                <br />
            </div>
            <button
                type="button"
                className="py-4 px-7 me-2 mb-2 text-xs text-black focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4  focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 my-7 mb-[10rem]"
            >
