    ...
    return (
        <div className="w-full rounded-3xl bg-black">
            ...
            <div className='flex justify-around' >
                ...
                <div>
                    <a href="https://gravitas.vit.ac.in/events/6b8842bf-3661-45de-9428-47f5996341b4" className="flex mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="ISA Logo" />
                        <span className=" text-2xl font-semibold whitespace-nowrap dark:text-white">GenHack24</span>
                    </a>
                </div>
                <div>
